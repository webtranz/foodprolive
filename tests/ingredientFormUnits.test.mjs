...
test('existing standard aliases are normalized while custom units remain selectable', () => {
  for (const [saved, expected] of [['gram', 'g'], ['Grams', 'g'], ['liter', 'l'], ['pcs', 'pieces']]) {
  ...
  assert.match(form, /isStandardConversionUnit \? normalizedConversionUnit : formData\.conversion_unit/);
